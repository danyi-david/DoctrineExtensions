    ...
    public function childrenQueryBuilder($node = null, $direct = false, $sortByField = null, $direction = 'ASC', $includeNode = false)
    {
        ...
        if (!$sortByField) {
            ...
            foreach ($sortByField as $key => $field) {
                ...
                if (($meta->hasAssociation($field) || $meta->hasField($field)) && in_array($fieldDirection, ['asc', 'desc'], true)) {
            ...
            if (($meta->hasAssociation($sortByField) || $meta->hasField($sortByField)) && in_array(strtolower($direction), ['asc', 'desc'], true)) {
